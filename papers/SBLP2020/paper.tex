\documentclass[manuscript, review, anonymous, sigconf]{acmart}
...
\begin{abstract}
  ...
  In this work, we describe and present a comparison between two 
  ...
  theoretical approach in both Coq proof assistant and Agda programming
